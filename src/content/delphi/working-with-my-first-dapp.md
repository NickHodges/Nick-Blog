...
title: Working with my First Dapp
postSlug: working-with-my-first-dapp
featured: false
tags:
  - delphi
description: 'Okay, for all you non-cool kids, "Dapp" is the short form of "Decentralized Application". I''m told that it is pronounced "Dap" and not "Dee-app".'
---

Okay, for all you non-cool kids, "[Dapp](https://www.wikiwand.com/en/Decentralized_application)" is the short form of "Decentralized Application".  I'm told that it is pronounced "Dap" and not "Dee-app".  I wrote about dapps a bit [in my last blog post.](http://www.codingindelphi.com/blog/everything-you-think-you-know-about-cryptocurrency-is-wrong-even-the-name/)

After posting, I decided I wanted to find a dapp to try out. I searched around a bit and found a number of them.  [FileCoin ](https://filecoin.io/)is the one that interests me the most, but they are still building it, and it won't be available until late next year at the earliest. 

I then stumbled upon [Steem](https://steem.io/).  The main outlet for Steem is SteemIt which is basically a user-run Blogging and commenting platform.  You can earn Steem Tokens by adding value to the blogging network through posts and comments, and curating those posts and comments.  By adding value, you earn Steem, and Steem is worth real money.
...
My first concern that SteemIt would become "one-sided", much like [Digg.com](http://digg.com/) did back in the 2000's, where one political slant would get all the up-votes.  However, while I don't completely understand how it works, it appears that users who tend to down-vote in a slanted way are punished. 
...
I created an account and started poking around.  There are some[ good introductory posts](https://steemit.com/welcome#Helpful_Posts_from_Steemit_Users), one of which made the wise recommendation to find a niche in SteemIt and fill it.  I noticed that there were not too many (any?) articles on software development, so I decided that would be my niche.  So far I've posted three articles on the [softwaredevelopment ](https://steemit.com/@trenchant)tag, and plan to do many more.
...
I warn you, though, if you want to create an account, you ***MUST* **remember your password, which is a large hash and provided by the Steem system.  There is **_no way_** to recover your password.  They'll give you the hash and you need to copy it and store it safely.   I confess I didn't get this part at first, and lost forever my account for "nickhodges" and had to come up with a different name ("TrenchantGuy") to have an account.  Silly me.  ([At least I'm not the only one.....](https://www.reddit.com/r/steemit/comments/84ytr8/anybody_know_how_to_recover_your_username/))
