...
title: Complete Martin Harvey’s Multithreading Article Online
postSlug: complete-martin-harveys-multithreading-article-online
featured: false
tags:
  - delphi
description: 'Threading in Delphi, or in any other tool for that matter, is difficult.'
---

Threading in Delphi, or in any other tool for that matter, is difficult.  There are a lot of good resources out there for Delphi developers, but perhaps none better than Martin Harvey’s “Multi-threading: The Delphi Way”.  There is a copy of it here --  [http://thaddy.co.uk/threads/](http://thaddy.co.uk/threads/) – but sadly it doesn’t include the graphics and the code. 
