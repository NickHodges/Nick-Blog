...
title: Four Humble Ideas for Embarcadero
postSlug: four-humble-ideas-for-embarcadero
featured: false
tags:
  - delphi
description: 'I hereby humbly offer the following four suggestions to improve the Delphi product and community.'
---
...
Have you guys seen the stuff done by [DevJet](http://www.devjetsoftware.com/)?  This is some seriously excellent work.  They have two main projects -- [Documentation Insight](http://www.devjetsoftware.com/products/documentation-insight/) and[ Code Insight Plus](http://www.devjetsoftware.com/products/codeinsightplus/) -- that are both excellent, polished, and incredibly useful.  Code Insight Plus is worth its weight in gold.  Embarcadero should strongly consider including these two projects as part of the RAD Studio product.  Shoot, they should get DevJet to write a bunch of features for the IDE.
...
[I've suggested this before, and want to suggest it again](http://www.nickhodges.com/post/In-Which-I-Argue-That-Embarcadero-Should-Open-Source-Their-Unit-Tests.aspx).  I can't add much to the post other than to say there is no downside and all upside.  I argued pretty strenuously for this, and continue to believe it is a good idea.
...
I was at [Philly Code Camp](http://phillydotnet.org/) this weekend.  It was fun as always.  At the after-party on Friday night I talked to a guy who took a day long class on [Microsoft's Roslyn compiler](https://github.com/dotnet/roslyn).  He talked about all the cool things he was building to automate code reviews by doing static analysis on the compiled code using the extensions from Roslyn.  I was at a talk where they mentioned how many bug fixes and improvements have come to [.Net Core](https://dotnet.github.io/) since it was open sourced.  And this is code from Microsoft.  Microsoft!  They open source their development environment and it is thriving. Check this out -- [here is Anders Hejlsberg's check-in log for TypeScript for the month of March](https://github.com/ahejlsberg?tab=overview&from=2018-03-01&to=2018-03-26).  You can interact with Anders on GitHub!
